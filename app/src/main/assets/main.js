...
function onClick(ids) {
    ...
    if (document.getElementById(ids).style.backgroundColor == "white") {
        clickCounter--;
    }
    else {
        ...
        if (clickCounter == 1) {
            ...
            document.getElementsByClassName("overBlock")[ids].style.transition = "background-Color 0.2s";
            ...
            if (idss1 != idss2) {
                if (document.getElementById(idss1.substr(0, idss1.length - 2)).style.backgroundColor === document.getElementById(idss2.substr(0, idss2.length - 2)).style.backgroundColor) {
                    ...
                    document.getElementById(idss1).style.transition = "background-color 0.2s";
                    document.getElementById(idss2).style.backgroundColor = "white";
                    document.getElementById(idss2).style.transition = "background-color 0.2s";
            ...
            for (i = 0; i < 2 * nColors; i++) {
                ...
                document.getElementsByClassName("overBlock")[i].style.transition = "background-color 0s";
            }
...
function displayMoves() {
    JSReceiver.display(clickCounter);
